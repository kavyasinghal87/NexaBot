...
const Sidebar = ({ isCollapsed, toggleSidebar }) => {
    ...
    return (
        <>
            ...
            {isLoggingOut && (
                <div className="fixed inset-0 z-50 flex flex-col items-center justify-center bg-[#020617]/80 backdrop-blur-sm animate-in fade-in duration-300">
                    <div className="flex flex-col items-center gap-4 p-8 rounded-2xl bg-[#0f172a] border border-gray-800 shadow-2xl animate-in zoom-in-95 duration-300">
                        ...
                        <div className="text-center space-y-1">
                            <h3 className="text-lg font-semibold text-white">Signing Out</h3>
            ...
            <aside className={`${isCollapsed ? 'w-20' : 'w-64'} bg-[#0F172A] border-r border-gray-800 flex flex-col h-screen fixed left-0 top-0 z-10 text-gray-300 transition-all duration-300 ease-in-out`}>
                ...
                <button
                    ...
                    className="absolute -right-3 top-6 bg-blue-600 rounded-full p-1 text-white shadow-lg border border-gray-800 hover:bg-blue-500 transition-colors z-20 cursor-pointer"
                >
